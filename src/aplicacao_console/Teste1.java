...
//		parte2();
	...
	public static void parte1 () {		
		...
		try {
			...
			System.out.println("cadastrou produto="+pizza.getNome()+pizza.getId());
			Produto sushi = Fachada.cadastrarProduto("Sushi", 40);
			System.out.println("cadastrou produto="+sushi.getNome()+sushi.getId());
...
//
	...
	public static void erros() {
		...
		try {
			Fachada.fecharPedido("98820-0222", "entrg");	//ok
